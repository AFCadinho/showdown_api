export const createBattleDocs = {
  ...
  notes: [
    ...
    "Ability activations komen terug als ability events. Stat boosts en drops komen terug als statChange events. Bij Intimidate komt eerst ability en daarna statChange.",
