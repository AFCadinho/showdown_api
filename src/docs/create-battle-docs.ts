export const createBattleDocs = {
  ...
  notes: [
    ...
    "Ability activations komen terug als ability events. Stat boosts en drops komen terug als statChange events. Bij Intimidate komt eerst ability en daarna statChange. Ability-stat boosts zoals Protosynthesis en Quark Drive komen terug als ability events met effect boost en stat.",
    "Tijdelijke Pokemon-effecten zoals trapping of confusion komen terug als pokemonEffect events met state start, activate of end.",
    "field.effects bevat actuele veldstatus zoals actieve weather, field conditions, terrain en side conditions. Terrain vervangt vorige terrain. Hazards zoals Stealth Rock blijven staan totdat Showdown removal meldt, bijvoorbeeld door Rapid Spin. Weather, terrain, Trick Room en Tailwind bevatten startedTurn, minDuration, maxDuration, minRemainingTurns en maxRemainingTurns in field.effects. Veranderingen komen daarnaast terug als fieldEffect events met state start, upkeep of end. Als Showdown metadata meestuurt, bevat het event ook source en sourceTarget.",
  ],
  successResponse: {
    success: true,
